 ...
 const [categories, setCategories] = useState<Set<string>>(new Set());
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        let categoriesList = res.data.books.map((b) => b.category);
  ...
  const stateCity = []; //Filtering data according to State from the cities database
  ...
  return (
    <>
      ...
      />
      {/* Filter Start */}
      <Filters borrow={false} status="Issued" handleSetBooks={handleSetBooks} />
      {/* Filter End */}
              ...
              <ChakraProvider>
                ...
                >
                  <TabList className="bg-blue-50 w-full py-2 rounded-3xl shadow-lg">
                    <Tab className="mx-2">Issued Items</Tab>
...
//     try {
//         const res = await fetch(`${templateString}/api/books/issuedBooks`);
