...
const PendingBooks = () => {
  ...
  const [pendingBooks, setPendingBooks] = useState<Books[]>([]);
  ...
  const handleSetBooks=(val:Books[])=>{
    setPendingBooks(val)
  }
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .post(`${process.env.NEXT_PUBLIC_NEXTAUTH_URL}/api/books/retrieveBooks`, {
        status: "Pending",
        borrow:false
      })
      .then((res) => {
  ...
  //Filtering data according to State from the cities database
  ...
  return (
    <>
      ...
      />
      {/* Filter Start */}
       <Filters borrow={false} status="Pending" handleSetBooks={handleSetBooks}/>
      {/* Filter End */}
                ...
                <>
                  ...
                  <div className="w-10/12 mx-auto">
                    ...
                    <div className="text-left   flex">
                      <ChakraProvider>
                        <RadioGroup value={condition} defaultValue="0">
                          ...
                          <div className="flex items-center">
                            <input
                              ...
                              value={2}
                              className="mx-3 my-2"
                              onClick={(e) => setCondition(e.currentTarget.value)}
                            ></input>
                            <label
                              htmlFor="3"
                              className="flex items-center text-lg"
      ...
      <div className=" ml-[30px] mt-10  lg:ml-[350px] flex-row sm:flex sm:items-center">
        <div>
          <ChakraProvider>
            ...
            >
              <TabList className="bg-blue-50 w-full py-2 rounded-3xl shadow-lg">
                <Tab className="mx-2">Pending Items</Tab>
...
//     try {
//         const res = await fetch(`${templateString}/api/books/pendingBooks`);
//         const pendingBooks = await res.json();
//         return {
//             props: {
